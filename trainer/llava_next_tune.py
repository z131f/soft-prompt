...
class llava_next_tune_trainer():
    def __init__(self, config, logger):
        ...
        # print('load model ...')
        self.model = ModifiedLlavaNext.from_pretrained(model_site, config=model_config, cache_dir=model_cache, device_map=config['device_map'], patch_num=patch_num, torch_dtype=torch.bfloat16)
    ...
    def eval(self):
        ...
        sentence_model = SentenceTransformer('all-mpnet-base-v2', device='cuda', cache_folder='model_cache/sentence_transformer') # 使用缓存目录以避免重复下载
